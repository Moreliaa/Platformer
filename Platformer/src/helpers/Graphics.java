...
public class Graphics {
	...
	private static void drawLineLoop(float x, float y, float width, float height) {
	...
	private static void drawQuadTex(Texture tex, float x, float y, int width, int height) {
        ...
        glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0,
                GL_RGBA, GL_UNSIGNED_BYTE, tex.getBuffer());
